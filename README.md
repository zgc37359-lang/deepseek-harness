...
![Desktop window](apps/desktop/docs/screenshot.png)
...
See [release-testing-plan.md](apps/desktop/release-testing-plan.md) for the full engineering plan. Short version:
